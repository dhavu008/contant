...
exit;
	$email->SetFrom('noreply@pblcentral.co.uk', 'PBLCentral',0); //Name is optional
	$email->Subject   = 'Action Note - ';
	$email->Body      = "test";
	$email->AddAddress('gediyadhaval0811@gmail.com');
	//$email->AddCC('mosh680@gmail.com');

	//$file_to_attach = $_SERVER["DOCUMENT_ROOT"].'/attachments/'.$filename;
